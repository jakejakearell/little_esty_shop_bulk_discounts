...
invoice_1 = Invoice.create!(customer_id: customer_1.id, status: 2, created_at: "1991-03-23 21:40:46")
invoice_2 = Invoice.create!(customer_id: customer_2.id, status: 0, created_at: "1992-01-28 21:40:46")
invoice_3 = Invoice.create!(customer_id: customer_3.id, status: 2, created_at: "1993-01-28 21:40:46")
invoice_4 = Invoice.create!(customer_id: customer_4.id, status: 2, created_at: "1994-01-28 21:40:46")
invoice_5 = Invoice.create!(customer_id: customer_5.id, status: 2, created_at: "1995-01-28 21:40:46")
invoice_6 = Invoice.create!(customer_id: customer_6.id, status: 0, created_at: "2021-01-28 21:40:46")
invoice_7 = Invoice.create!(customer_id: customer_6.id, status: 2, created_at: "2021-01-28 21:40:46")
