...
ii_1 = InvoiceItem.create!(invoice_id: invoice_2.id, item_id: item_5.id, quantity: 10, unit_price: 3, status: 2)
ii_2 = InvoiceItem.create!(invoice_id: invoice_2.id, item_id: item_6.id, quantity: 2, unit_price: 15, status: 2)
ii_3 = InvoiceItem.create!(invoice_id: invoice_2.id, item_id: item_7.id, quantity: 5, unit_price: 9, status: 2)
ii_4 = InvoiceItem.create!(invoice_id: invoice_2.id, item_id: item_8.id, quantity: 5, unit_price: 1, status: 2)
